...
const uint32_t PROGMEM unicode_map[] = {
   [MONKEY] = 0x1F649, // 🙉 0x1F412
};

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT_ext_ansi(
    KC_ESC,  KC_F1,   KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,                 KC_MPLY, KC_VOLD, KC_VOLU,                              X(MONKEY),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_m0116_ansi(
                                                              MO(_FN),
		KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, TG(_NUMLOCK),   KC_PEQL, KC_PSLS, KC_PAST,
    ...
    [_NUMLOCK] = LAYOUT_m0116_ansi(
                                                              MO(_FN),
		KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, TG(_NUMLOCK),   KC_PEQL, KC_PSLS, KC_PAST,
		KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,          KC_HOME,        KC_UP,   KC_PGUP, KC_PPLS,
		KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,           KC_LEFT,        KC_P5,   KC_RGHT, KC_PMNS,
		KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,                   KC_END,         KC_DOWN, KC_PGDN,
		KC_LCAP, KC_LALT, KC_LGUI, KC_GRV,                    KC_SPC,           KC_BSLS, KC_LEFT, KC_RGHT, KC_DOWN, KC_UP,            KC_INS,         KC_DEL,           KC_PENT
    ),

    [_FN] = LAYOUT_m0116_ansi(
	                                                          KC_TRNS,
		...
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                   QK_BOOT,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS,        KC_TRNS,          KC_TRNS
    )
}; */
