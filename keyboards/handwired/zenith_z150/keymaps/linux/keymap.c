...
*/
    ...
    KC_F9,  KC_F10,LT(_EXTRA, KC_LALT),         KC_GRV,                                 KC_SPC,                                            KC_CAPS,       KC_INS,           KC_DEL
    ),
    [_NUMLOCK] = LAYOUT(
    KC_F1,  KC_F2, KC_ESC,   KC_1,    KC_2,   KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,   TG(_NUMLOCK),     MO(_EXTRA),    KC_RGUI,
    ...
    KC_F9,  KC_F10,LT(_EXTRA, KC_LALT),         KC_GRV,                                 KC_SPC,                                            KC_CAPS,       KC_P0,            KC_PDOT
    ),
    [_EXTRA] = LAYOUT(
    TROLL,  KC_NO, AU_TOGG, KC_NO,    KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,  KC_NO,   KC_NO,   QK_BOOT,   KC_NO,            KC_NO,         KC_NO,
    KC_NO,  KC_NO, KC_NO,   KC_NO,    KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,  KC_NO,   KC_NO,              KC_NO,   KC_NO,       KC_NO,     KC_MUTE,
    KC_NO,  KC_NO, KC_NO,   KC_NO,    KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,  KC_NO,            KC_NO,     KC_NO,   KC_NO,       KC_NO,     KC_VOLD,
    KC_NO,  KC_NO, KC_NO,             KC_NO,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,    KC_NO,  KC_NO,   KC_NO,   KC_NO,     KC_NO,   KC_NO,       KC_NO,     KC_VOLU,
    KC_NO,  KC_NO, KC_NO,            KC_NO,                                 KC_NO,                                             KC_NO,         KC_BRID,          KC_BRIU
    )
};
...
#ifdef AUDIO_ENABLE
float sound[][2] = SONG(TERMINAL_SOUND);
float troll[][2] = SONG(ROLL);
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
